...
fig, ax = ox.plot_graph(road_network, show=True, close=True)

# Save the figure if needed
plt.savefig("san_antonio_streets.png")

print("Road network visualization complete. Saved as 'san_antonio_streets.png'.")
